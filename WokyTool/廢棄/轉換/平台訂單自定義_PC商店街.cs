...
{
    public class 平台訂單自定義_PC商店街 //: 平台訂單自定義介面
    {
        ...
        {
            var Items_ = 資料列舉_.Select(Value => new 平台訂單回單轉換_PC商店街(Value));

            String Title_ = String.Format("PC商店街回單_{0}", 時間.目前日期);
            舊函式.ExportCSV<平台訂單回單轉換_PC商店街>(Title_, Items_);
        }*/
    }
}
