...
namespace WokyTool.DataExport
{
    class 回單號結構_Momo : 可格式化_Excel
    {
        ...
        public void TitleToExcelCell(Microsoft.Office.Interop.Excel.Application App_)
        {
            ...
            App_.Cells[1, 6] = "配送單號";
            App_.Cells[1, 7] = "訂單類別";
            App_.Cells[1, 8] = "客戶配送需求";
            App_.Cells[1, 9] = "轉單日";
            App_.Cells[1, 10] = "預計出貨日";
            App_.Cells[1, 11] = "收件人姓名";
            App_.Cells[1, 12] = "收件人電話";
            App_.Cells[1, 13] = "收件人行動電話";
            App_.Cells[1, 14] = "收件人地址";
        ...
        public void ToExcelCell(Microsoft.Office.Interop.Excel.Application App_, int Row_)
        {
            ...
            App_.Cells[Row_, 7] = _Data.訂單類別;
            App_.Cells[Row_, 8] = _Data.備註;
            App_.Cells[Row_, 9] = _Data.無用_轉單日;
            App_.Cells[Row_, 10] = _Data.預計出貨日;
            App_.Cells[Row_, 11] = _Data.姓名;
            App_.Cells[Row_, 12] = _Data.電話;
            App_.Cells[Row_, 13] = _Data.手機;
            App_.Cells[Row_, 14] = _Data.地址;
            App_.Cells[Row_, 15] = _Data.無用_商品原廠編號;
            App_.Cells[Row_, 16] = _Data.品號;
            App_.Cells[Row_, 17] = _Data.無用_品名;
            App_.Cells[Row_, 18] = _Data.單名編號;
            App_.Cells[Row_, 19] = _Data.無用_單品詳細;
            App_.Cells[Row_, 20] = _Data.數量;
            App_.Cells[Row_, 21] = _Data.無用_進價;
            App_.Cells[Row_, 22] = _Data.無用_贈品;
            App_.Cells[Row_, 23] = _Data.無用_訂購人姓名;
            App_.Cells[Row_, 24] = _Data.無用_發票號碼;
