...
namespace WokyTool.DataExport
{
    class 回單號結構_Momo第三方_進度 : 可格式化_Excel
    {
        ...
        public void ToExcelCell(Microsoft.Office.Interop.Excel.Application App_, int Row_)
        {
            ...
            App_.Cells[Row_, 4] = _Data.約定配送日;
            App_.Cells[Row_, 5] = _Data.無用_宅單備註;
            App_.Cells[Row_, 6] = _Data.訂單編號;
            App_.Cells[Row_, 7] = _Data.姓名;
            App_.Cells[Row_, 8] = _Data.地址;
            App_.Cells[Row_, 9] = _Data.無用_出貨地址;
            App_.Cells[Row_, 10] = _Data.無用_回收地址;
            App_.Cells[Row_, 11] = _Data.訂單類別;
            App_.Cells[Row_, 12] = _Data.備註;
            App_.Cells[Row_, 13] = _Data.無用_轉單日;
            App_.Cells[Row_, 14] = _Data.預計出貨日;
