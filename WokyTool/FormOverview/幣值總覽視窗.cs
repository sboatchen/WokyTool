...
{
    public partial class 幣值總覽視窗 : Form
    {
        public 幣值總覽視窗()
        {
            InitializeComponent();

            this.dataGridView1.DataSource = 幣值管理器.Instance.Binding;
        ...
        private void 刪除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                幣值管理器.Instance.Delete((幣值資料)this.dataGridView1.SelectedRows[0].DataBoundItem);
                this.dataGridView1.Refresh();
            }
        }
    }
