...
namespace WokyTool
{
    public partial class 物品小類總覽視窗 : Form
    {
        protected 監測綁定更新<物品小類資料> _Listener;

        public 物品小類總覽視窗()
        {
            InitializeComponent();

            _Listener = new 監測綁定更新<物品小類資料>(物品小類管理器.Instance.Binding, 列舉.監測類型.被動通知_值, 物品小類資料更新);
        ...
        private void 刪除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                物品小類管理器.Instance.Delete((物品小類資料)this.dataGridView1.SelectedRows[0].DataBoundItem);
                _Listener.Refresh();
            }
        }
    }
