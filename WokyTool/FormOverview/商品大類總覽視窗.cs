...
namespace WokyTool
{
    public partial class 商品大類總覽視窗 : Form
    {
        protected 監測綁定更新<商品大類資料> _Listener;

        public 商品大類總覽視窗()
        {
            InitializeComponent();

            _Listener = new 監測綁定更新<商品大類資料>(商品大類管理器.Instance.Binding, 列舉.監測類型.被動通知_值, 商品大類資料更新);
        ...
        private void 刪除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                商品大類管理器.Instance.Delete((商品大類資料)this.dataGridView1.SelectedRows[0].DataBoundItem);
                _Listener.Refresh();
            }
        }
    }
