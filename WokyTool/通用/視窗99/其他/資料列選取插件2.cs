...
{
    public class 資料列選取插件2<T> where T : 新版可記錄資料<T>
    {
        private 可儲存資料管理器<T> _資料管理器;
        ...
        public 資料列選取插件2(可儲存資料管理器<T> 資料管理器_, System.Windows.Forms.BindingSource 資料BindingSource_, System.Windows.Forms.DataGridView DataGridView_, int 欄位_)
        {
            _資料管理器 = 資料管理器_;
