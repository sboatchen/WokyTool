...
namespace WokyTool.通用
{
    public class 視窗管理器
    {
        ...
        private 視窗管理器()
        {
            ...
            _資料書.Add(取得編號(列舉.編號.品類, 列舉.視窗.總覽), typeof(品類總覽視窗));
            ...
            _資料書.Add(取得編號(列舉.編號.預留, 列舉.視窗.總覽), typeof(預留總覽視窗));
            _資料書.Add(取得編號(列舉.編號.預留, 列舉.視窗.詳細), typeof(預留詳細視窗));
            _資料書.Add(取得編號(列舉.編號.預留, 列舉.視窗.篩選), typeof(預留篩選視窗));

            _資料書.Add(取得編號(列舉.編號.預留新增, 列舉.視窗.總覽), typeof(預留新增總覽視窗));
            _資料書.Add(取得編號(列舉.編號.預留新增, 列舉.視窗.詳細), typeof(預留新增詳細視窗));
            _資料書.Add(取得編號(列舉.編號.預留新增, 列舉.視窗.篩選), typeof(預留新增篩選視窗));
            ...
            _資料書.Add(取得編號(列舉.編號.一般訂單新增, 列舉.視窗.篩選), typeof(一般訂單新增篩選視窗));

            _資料書.Add(取得編號(列舉.編號.一般訂單, 列舉.視窗.總覽), typeof(一般訂單總覽視窗));
            _資料書.Add(取得編號(列舉.編號.一般訂單, 列舉.視窗.詳細), typeof(一般訂單詳細視窗));
            _資料書.Add(取得編號(列舉.編號.一般訂單, 列舉.視窗.篩選), typeof(一般訂單篩選視窗));
