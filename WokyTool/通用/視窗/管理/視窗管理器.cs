...
namespace WokyTool.通用
{
    public class 視窗管理器
    {
        ...
        private 通用視窗介面 取得視窗(列舉.編號 編碼類型_, 列舉.視窗 視窗類型_)
        {
            switch (視窗類型_)
            {
                case 列舉.視窗.總覽:
        ...
        public void 顯現(列舉.編號 編碼類型_, 列舉.視窗 視窗類型)
        {
        ...
        public void 顯現(列舉.編號 編碼類型_, 列舉.視窗 視窗類型, int 編號_)
        {
            通用視窗介面 視窗_ = 取得視窗(編碼類型_, 視窗類型);
        ...
        public void 隱藏(列舉.編號 編碼類型_, 列舉.視窗 視窗類型)
        {
            通用視窗介面 視窗_ = 取得視窗(編碼類型_, 視窗類型);
