        ...
        public static List<PDF拷貝元件> 拷貝資料列
        {
            get
            {
                if (_拷貝資料列 == null)
                {
                    ...
                    _拷貝資料列.Add(new PDF拷貝元件(new Rectangle(0, 0, 595, 280), 0, 17));
                    _拷貝資料列.Add(new PDF拷貝元件(new Rectangle(0, 280, 595, 560), 0, 17));
                    _拷貝資料列.Add(new PDF拷貝元件(new Rectangle(0, 560, 595, 840), 0, 17));
                }
        ...
        public static Dictionary<PDF字串讀出元件, PDF字串寫入元件> 設定資料書
        {
            get 
            {
                if (_設定資料書 == null)
                {
                    ...
                    _設定資料書.Add(new PDF字串讀出元件(new Rectangle(130, 745, 260, 770)), new PDF字串寫入元件(new Rectangle(5, 555, 295, 596), 常數.通用字體));
                    _設定資料書.Add(new PDF字串讀出元件(new Rectangle(430, 745, 560, 770)), new PDF字串寫入元件(new Rectangle(305, 555, 595, 596), 常數.通用字體));
                    _設定資料書.Add(new PDF字串讀出元件(new Rectangle(130, 465, 260, 485)), new PDF字串寫入元件(new Rectangle(5, 275, 295, 316), 常數.通用字體));
                    _設定資料書.Add(new PDF字串讀出元件(new Rectangle(430, 465, 560, 485)), new PDF字串寫入元件(new Rectangle(305, 275, 595, 316), 常數.通用字體));
