...
{
    public class 平台訂單匯入轉換_ibonMart : 平台訂單自定義介面, 可讀出介面_CSV<平台訂單匯入資料>
    {
        ...
        public 平台訂單匯入轉換_ibonMart(公司資料 公司_)
        {
            公司 = 公司_;
            客戶 = 客戶資料管理器.獨體.Get("ibon mart");
        }
        ...
        {
            var 轉換_ = new 平台訂單回單轉換_ibonMart(資料_);
