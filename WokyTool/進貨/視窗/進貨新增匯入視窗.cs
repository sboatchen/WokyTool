...
{
    public partial class 進貨新增匯入視窗 : 新增總覽視窗
    {
        public override Type 資料類型 { get { return typeof(進貨新增匯入資料); } }
        ...
        public override 通用視窗介面 取得篩選視窗實體
        {
            get
            {
                var 視窗_ = new 進貨新增匯入篩選視窗(資料管理器.視窗篩選器);
                視窗_.初始化();
                return 視窗_;
            }
        }
        ...
        public override 通用視窗介面 取得詳細視窗實體
        {
            get
            {
                var 視窗_ = new 進貨新增匯入詳細視窗(資料管理器);
                視窗_.初始化();
                return 視窗_;
            }
        }

        public 進貨新增匯入資料管理器 資料管理器 = new 進貨新增匯入資料管理器();
        ...
        {
            通用更新匯入轉換<進貨新增匯入資料> 轉換_ = new 通用更新匯入轉換<進貨新增匯入資料>();
            IEnumerable<進貨新增匯入資料> 資料列舉_ = 檔案.詢問並讀出(轉換_);
