...
{
    public class 進貨新增資料篩選 : 通用可篩選介面<進貨新增資料>
    {
        ...
        public override IEnumerable<進貨新增資料> 篩選(IEnumerable<進貨新增資料> 資料列舉_)
        {
            IEnumerable<進貨新增資料> 目前列舉_ = 資料列舉_;
            ...
            if (目前列舉_ != 資料列舉_)
                return 目前列舉_.DefaultIfEmpty(進貨新增資料.空白);
            return 目前列舉_;
        }
    }
}
