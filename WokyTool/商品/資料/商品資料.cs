...
namespace WokyTool.商品
{
    ...
    public class 商品資料 : MyKeepableData<商品資料>
    {
        ...
        public override void 檢查合法()
        {
            ...
            if (需求1.編號是否合法() == false)
                throw new Exception("商品資料:需求編號1不合法:" + 需求編號1);

            if (需求2.編號是否合法() == false)
                throw new Exception("商品資料:需求編號2不合法:" + 需求編號2);

            if (需求3.編號是否合法() == false)
                throw new Exception("商品資料:需求編號3不合法:" + 需求編號3);

            if (需求4.編號是否合法() == false)
                throw new Exception("商品資料:需求編號4不合法:" + 需求編號4);
