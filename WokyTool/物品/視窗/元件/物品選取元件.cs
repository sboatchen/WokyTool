...
{
    public partial class 物品選取元件 : 抽象資料選取元件
    {
        ...
        public 物品資料篩選 篩選器 { get; protected set; }

        public 物品選取元件(選取元件類型 元件類型_)
        {
            元件類型 = 元件類型_;
            ...
            篩選器 = (物品資料篩選)管理器.視窗篩選器;
        }

        public 物品選取元件() : this(選取元件類型.指定)
        {
        }
