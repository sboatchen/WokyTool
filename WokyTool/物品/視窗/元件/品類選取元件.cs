...
namespace WokyTool.物品
{
    ...
    {
        public override BindingSource 資料BS { get { return this.品類資料BindingSource; } }
        ...
        protected override 可清單列舉資料管理介面 取得管理器實體()
        {
            ...
            {
                case 選取元件類型.指定:
                    return 品類資料管理器.獨體.清單管理器;
                case 選取元件類型.篩選:
                    return 品類資料管理器.獨體.篩選管理器;
                default:
        ...
        public 品類資料篩選 篩選器 { get; protected set; }
