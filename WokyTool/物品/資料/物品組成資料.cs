...
namespace WokyTool.物品
{
    ...
    public class 物品組成資料 : MyData
    {
        ...
        public void append(商品資料 商品資料_, int 數量_)
        {
            append(商品資料_.需求1, 商品資料_.數量1 * 數量_);
            append(商品資料_.需求2, 商品資料_.數量2 * 數量_);
            append(商品資料_.需求3, 商品資料_.數量3 * 數量_);
            append(商品資料_.需求4, 商品資料_.數量1 * 數量_);
            append(商品資料_.需求5, 商品資料_.數量5 * 數量_);
        }
