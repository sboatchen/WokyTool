...
namespace WokyTool.物品
{
    ...
    public class 物品小類資料 : 新版可記錄資料<物品小類資料>
    {
        ...
        public static readonly 物品小類資料 不篩 = new 物品小類資料
        {
            編號 = 常數.不篩資料編碼,
            名稱 = 字串.不篩選,
        };
        ...
        public override void 合法檢查(可處理檢查介面 介面_, IEnumerable<物品小類資料> 資料列舉_)
        {
        ...
        {
            foreach (物品資料 資料_ in 物品資料管理器.獨體.資料列舉2.Where(Value => Value.小類 == this))
            {
                介面_.錯誤(資料_, "資料綁定中");
            }
        }
