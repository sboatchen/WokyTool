...
namespace WokyTool.物品
{
    ...
    public class 物品品牌資料 : 新版可記錄資料<物品品牌資料>
    {
        [JsonProperty]
        ...
        public static 物品品牌資料 不篩 = new 物品品牌資料
        {
            編號 = 常數.不篩資料編碼,
            名稱 = 字串.不篩選,
        };
        ...
        {
            IEnumerable<物品品牌資料> 物品品牌資料列舉_ = (IEnumerable<物品品牌資料>)資料列舉_;

            if (String.IsNullOrEmpty(名稱))
                介面_.錯誤(this, "名稱不合法");
            else if (物品品牌資料列舉_.Where(Value => 名稱.Equals(Value.名稱)).Count() > 1)
                介面_.錯誤(this, "名稱重複");
        }
