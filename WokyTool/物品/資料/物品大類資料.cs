...
namespace WokyTool.物品
{
    ...
    public class 物品大類資料 : MyKeepableData
    {
        [JsonProperty]
        ...
        {
            物品大類資料 Data_ = Item_ as 物品大類資料;
            if (Data_ == null)
                throw new Exception("物品大類資料:覆蓋失敗:" + this.GetType());
        ...
        public override Boolean 是否一致(object Item_)
        {
            物品大類資料 Data_ = Item_ as 物品大類資料;
            if (Data_ == null)
                throw new Exception("物品大類資料:比較失敗:" + this.GetType());
