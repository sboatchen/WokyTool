...
namespace WokyTool.平台訂單
{
    public partial class 平台訂單新增匯入視窗 : 新增總覽視窗
    {
        ...
        {
            平台訂單匯入處理_myfone 轉換器_ = new 平台訂單匯入處理_myfone();
            List<平台訂單新增匯入資料> 資料列_ = 檔案.詢問並讀出(轉換器_);
            匯入完成(轉換器_, 資料列_);
        }

        private void 泛科ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            平台訂單匯入處理_泛科 轉換器_ = new 平台訂單匯入處理_泛科();
            List<平台訂單新增匯入資料> 資料列_ = 檔案.詢問並讀出(轉換器_);
            匯入完成(轉換器_, 資料列_);
        }
        ...
        {
            平台訂單匯入處理_愛料理 轉換器_ = new 平台訂單匯入處理_愛料理();
            List<平台訂單新增匯入資料> 資料列_ = 檔案.詢問並讀出(轉換器_);
            匯入完成(轉換器_, 資料列_);
        }
        ...
        {
            平台訂單匯入處理_蝦皮 轉換器_ = new 平台訂單匯入處理_蝦皮();
            List<平台訂單新增匯入資料> 資料列_ = 檔案.詢問並讀出(轉換器_);
            匯入完成(轉換器_, 資料列_);
        }
        ...
        private void 官網ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            平台訂單匯入處理_官網 轉換器_ = new 平台訂單匯入處理_官網();
            List<平台訂單新增匯入資料> 資料列_ = 檔案.詢問並讀出(轉換器_);
            匯入完成(轉換器_, 資料列_);
        }

        private void pINKOIToolStripMenuItem_Click(object sender, EventArgs e)
        {
            平台訂單匯入處理_PINKOI 轉換器_ = new 平台訂單匯入處理_PINKOI();
            List<平台訂單新增匯入資料> 資料列_ = 檔案.詢問並讀出(轉換器_);
            匯入完成(轉換器_, 資料列_);
        }

        private void 瑪黑ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            平台訂單匯入處理_瑪黑 轉換器_ = new 平台訂單匯入處理_瑪黑();
            List<平台訂單新增匯入資料> 資料列_ = 檔案.詢問並讀出(轉換器_);
            匯入完成(轉換器_, 資料列_);
        }
    }
