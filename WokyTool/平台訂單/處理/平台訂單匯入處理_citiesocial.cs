...
{
    public class 平台訂單匯入處理_citiesocial : 平台訂單匯入處理介面, 可讀出介面_EXCEL<平台訂單新增匯入資料>
    {
        ...
        public 平台訂單匯入處理_citiesocial()
        {
            客戶 = 客戶資料管理器.獨體.取得("citiesocial");
        }
