        ...
        public static Dictionary<PDF圖片字串讀出元件, PDF字串寫入元件> 設定資料書
        {
            get 
            {
                if (_設定資料書 == null)
                {
                    ...
                    _設定資料書.Add(new PDF圖片字串讀出元件(new Rect(575, 490, 400, 70)), new PDF字串寫入元件(new Rectangle(5, 785, 295, 830), 常數.通用字體));
                    _設定資料書.Add(new PDF圖片字串讀出元件(new Rect(1995, 490, 400, 70)), new PDF字串寫入元件(new Rectangle(305, 785, 595, 830), 常數.通用字體));
                    _設定資料書.Add(new PDF圖片字串讀出元件(new Rect(575, 2530, 400, 70)), new PDF字串寫入元件(new Rectangle(5, 0, 295, 45), 常數.通用字體));
                    _設定資料書.Add(new PDF圖片字串讀出元件(new Rect(1995, 2530, 400, 70)), new PDF字串寫入元件(new Rectangle(305, 0, 595, 45), 常數.通用字體));
                }
